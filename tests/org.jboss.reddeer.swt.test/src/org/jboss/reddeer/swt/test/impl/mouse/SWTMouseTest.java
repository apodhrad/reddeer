...
import org.jboss.reddeer.swt.impl.mouse.SWTMouse;
 ...
 * 
 */
public class SWTMouseTest extends RedDeerTest {
	...
	public void mouseClickTest() {
		...
		new SWTMouse().click(rShell.x, rShell.y);
	...
	public void mouseDoubleClickTest() {
		Rectangle rShell = getAbsoluteBounds(shell);
		new SWTMouse().doubleClick(rShell.x, rShell.y);
	...
	public void mouseHoverTest() {
		...
		new SWTMouse().hover(rLabel.x, rLabel.y);
	...
	public void mouseDragAndDropTest() {
		...
		int c = 100;
		new SWTMouse().dragAndDrop(r1.x + c, r1.y + c, r2.x + c, r2.y + c);
