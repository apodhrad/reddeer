...
import org.jboss.reddeer.graphiti.handler.GraphitiHandler;
...
public class LabeledGraphitiEditPart extends LabeledEditPart implements GraphitiEditPart {
	...
	public ContextButton getContextButton(String label) {
		List<ContextButton> contextButtons = GraphitiHandler.getInstance().getContextButtonEntries(editPart);
	...
	public void doubleClick() {
		GraphitiHandler.getInstance().doubleClick(editPart);
	}
